...
class Product(models.Model):
    ...
    def _compute_quantities_dict(self, lot_id, owner_id, package_id, from_date=False, to_date=False):
        ...
        virtual_box_res = dict((item['product_id'][0], (item['virtual_box'], item['reserved_quantity'])) for item in Quant._read_group(domain_quant, ['product_id', 'virtual_box', 'reserved_quantity'], ['product_id'], orderby='id'))
